...
container.register<VocabularyControllerInterface>('VocabularyInterfaceController', VocabularyController)
container.register<SentenceControllerInterface>('SentenceControllerInterface', SentenceController)